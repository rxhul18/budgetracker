...
const columns: ColumnDef<TransactionHistoryRow>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <p className="text-base rounded-lg bg-gray-400/5 p-2 text-center font-medium">{row.original.formattedAmount}</p>
        )
    },
    {
        id: "actions",
...
function TransactionsTable({ from, to }: Props) {
    ...
    const categoriesOptions = useMemo(() => {
        ...
        historyQuery.data?.forEach((transaction: { category: any; categoryIcon: any; }) => {
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align='end'>
                    <DropdownMenuLabel>Acitons</DropdownMenuLabel>
